...
def max_ss_load_mw(from_datetime_str, to_datetime_str, excel_path=r'max_ss_load_mvar.xlsx', from_hour1=None,
...
df = max_ss_load_mw(from_datetime_str='2022-7-1 00:00', to_datetime_str='2022-7-31 23:00',
